...
<head>
  ...
  <title>Veltrix | Mini Sprint</title>
    ...
    <section class="section-block">
      <div class="container product-detail-grid">
        ...
        <div class="product-detail-copy">
          <span class="eyebrow">Infantil running</span>
          <h1>Mini Sprint</h1>
          <p class="product-price">$68</p>
          <p class="rating">★★★★☆ <span>4.3 de 5</span></p>
          <p class="product-description">Mini Sprint está diseñado para los pequeños atletas que comienzan a correr. Ligero y seguro, con suela antideslizante para aventuras por el parque.</p>
          ...
          <div class="reviews-panel">
            ...
            <div class="review-item">
              <p class="review-text">"Cómodas y ligeras, a mi hijo le encantan."</p>
              <p class="review-author">— Mariana, MX</p>
            </div>
            <div class="review-item">
              <p class="review-text">"Se sienten seguras y perfectas para correr en el jardín."</p>
              <p class="review-author">— Joaquín, AR</p>
            </div>
          </div>
        </div>
      </div>
