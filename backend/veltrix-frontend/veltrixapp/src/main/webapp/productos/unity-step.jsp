...
<head>
  ...
  <title>Veltrix | Unity Step</title>
    ...
    <section class="section-block">
      <div class="container product-detail-grid">
        ...
        <div class="product-detail-copy">
          <span class="eyebrow">Unisex casual</span>
          <h1>Unity Step</h1>
          <p class="product-price">$110</p>
          <p class="rating">★★★★☆ <span>4.6 de 5</span></p>
          <p class="product-description">Unity Step es una zapatilla unisex diseñada para combinar comodidad y estilo cotidiano. Su apariencia versátil funciona igual de bien en el trabajo, la universidad o una salida casual.</p>
          ...
          <div class="reviews-panel">
            ...
            <div class="review-item">
              <p class="review-text">"Un estilo limpio y muy cómodo para todo el día."</p>
              <p class="review-author">— Jaime, MX</p>
            </div>
            <div class="review-item">
              <p class="review-text">"Funciona igual de bien para hombres y mujeres."</p>
              <p class="review-author">— Camila, AR</p>
            </div>
          </div>
        </div>
      </div>
