    ...
    <section class="section-block">
      <div class="container product-detail-grid">
        ...
        <div class="product-detail-copy">
          <span class="eyebrow">Casual kids</span>
          <h1>Star Lite</h1>
          <p class="product-price">$70</p>
          <p class="rating">★★★★☆ <span>4.4 de 5</span></p>
          <p class="product-description">Star Lite ofrece estilo divertido y confort para los más pequeños. Su estructura suave brinda un ajuste confortable para juegos y paseos diarios.</p>
          ...
          <div class="reviews-panel">
            ...
            <div class="review-item">
              <p class="review-text">"A mi hija le encantan y no se las quiere quitar."</p>
              <p class="review-author">— Paula, AR</p>
            </div>
            <div class="review-item">
              <p class="review-text">"Se sostienen bien en el pie y son muy suaves."</p>
              <p class="review-author">— Ana, MX</p>
            </div>
          </div>
        </div>
      </div>
