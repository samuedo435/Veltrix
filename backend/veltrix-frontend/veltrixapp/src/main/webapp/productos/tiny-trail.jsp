...
<head>
  ...
  <title>Veltrix | Tiny Trail</title>
    ...
    <section class="section-block">
      <div class="container product-detail-grid">
        ...
        <div class="product-detail-copy">
          <span class="eyebrow">Trail kids</span>
          <h1>Tiny Trail</h1>
          <p class="product-price">$75</p>
          <p class="rating">★★★★☆ <span>4.7 de 5</span></p>
          <p class="product-description">Tiny Trail ofrece agarre extra y un diseño divertido para carreras en senderos suaves. Perfecto para pequeños exploradores con espíritu aventurero.</p>
          ...
          <div class="reviews-panel">
            ...
            <div class="review-item">
              <p class="review-text">"Muy liviano y resistente para jugar al aire libre."</p>
              <p class="review-author">— Valentina, CO</p>
            </div>
            <div class="review-item">
              <p class="review-text">"A mi hija le encantó la suela con agarre."</p>
              <p class="review-author">— Paula, PE</p>
            </div>
          </div>
        </div>
      </div>
